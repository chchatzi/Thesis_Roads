...
def checkforcross2(twentylines,roadline):
...
def checkforcross(twentylines, roadline):
    ...
    if m>f*1.9 and m>l*1.9:
        ...
        differences = []
        dif8start = LineString([end8one, mid9]).length* 111.139 
        dif8end = LineString([end8tow, mid9]).length* 111.139 
        print(LineString([end8one, mid9]))
        print(LineString([end8tow, mid9]))
        if (dif8start-dif8end) > 0:
            if (dif8start - dif8end) > 0.89*dif8end:
                differences.append(1)
        elif (dif8start-dif8end) < 0:
            if dif8end-dif8start > 0.89*dif8start:
                differences.append(1)

        dif9start = LineString([end9one, mid10]).length* 111.139 
        dif9end = LineString([end9tow, mid10]).length* 111.139 
        print(LineString([end9one, mid10]))
        print(LineString([end9tow, mid10]))
        if (dif9start-dif9end) > 0:
            if (dif9start - dif9end) > 0.89*dif9end:
                differences.append(1)
        elif (dif9start-dif9end) < 0:
            if dif9end-dif9start > 0.89*dif9start:
                differences.append(1)
        
        dif10start = LineString([end10one, mid11]).length* 111.139 
        dif10end = LineString([end10tow, mid11]).length* 111.139 
        if (dif10start-dif10end) > 0:
            if (dif10start - dif10end) > 0.89*dif10end:
                differences.append(1)
        elif (dif10start-dif10end) < 0:
            if dif10end-dif10start > 0.89*dif10start:
                differences.append(1)
        print(LineString([end10one, mid11]))
        print(LineString([end10tow, mid11]))
        dif11start = LineString([end11one, mid12]).length* 111.139 
        dif11end = LineString([end11tow, mid12]).length* 111.139 
        if (dif11start-dif11end) > 0:
            if (dif11start - dif11end) > 0.89*dif11end:
                differences.append(1)
        elif (dif11start-dif11end) < 0:
            if dif11end-dif11start > 0.89*dif11start:
                differences.append(1)
        print(LineString([end11one, mid12]))
        print(LineString([end11tow, mid12]))
...
def checkforTcase2(twentylines, roadline):
    ...
    l = avgwidth2(last)
    #print(f, "",m, "", l)
    if m>f*1.4 and m>l*1.4:
        print("mid is 1.3 times higher")
